...
},{"../":9,"jquery":12,"moment":13}],2:[function(require,module,exports){
...
},{"./raf":7,"estira":11,"jquery":12}],3:[function(require,module,exports){
var has = Object.prototype.hasOwnProperty;
...
},{"./element":2,"./vertical":10}],5:[function(require,module,exports){
...
},{"./raf":7,"./range":8,"jquery":12}],7:[function(require,module,exports){
  ...
  mousedown: function(ev) {
    ...
    $(document).one('mouseup.elessar touchend.elessar', function(ev) {
      ...
      if(self.hasChanged && !self.swapping) 
        self.trigger('change', [self.range, self.$el]);
      self.swapping = false;
...
},{"./element":2,"./eventprop":3,"./vertical":10,"jquery":12}],9:[function(require,module,exports){
var Element = require('./element');
var Range = require('./range');
...
},{"./element":2,"./eventprop":3,"./indicator":4,"./mark.js":5,"./phantom":6,"./range":8,"./vertical":10,"jquery":12}],10:[function(require,module,exports){
module.exports = {
	isVertical: function() {
